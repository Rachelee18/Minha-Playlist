...
function PlaylistEditor() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gray-50">
      ...
      {/* Lista da Playlist sem DnD */}
      <div className="w-[500px] h-[620px] rounded-xl shadow-[0_-10px_15px_5px_rgba(0,0,0,0.1)] absolute left-1/2 top-56 -translate-x-1/2 flex flex-col items-center justify-start overflow-y-auto transition-all bg-white">
        {playlistMusics.length === 0 ? (
          ...
          <div className="w-full p-4">
            {playlistMusics.map((music, index) => (
              <div
                key={`${music.id}-${index}`}
                className="flex justify-between items-center p-3 mb-2 rounded-lg transition-all bg-gray-100 hover:bg-gray-200"
              >
      ...
      {/* MusicList na parte inferior sem DnD */}
      <div className="w-[1910px] h-36 rounded-xl shadow-[-5px_15px_10px_20px_rgba(1,0,0,0.1)] absolute justify-center items-center left-1/2 -translate-x-1/2 bottom-2 transition-all bg-white/30">
